...
\usepackage{rotating}   % to rotate figures with the sidewaysfigure environnement.
...
\definecolor{QAboxcolor}{HTML}{F5FFEB} % couleur QA box
%\definecolor{persoblue}{HTML}{CBFCFF}
\definecolor{persoblue}{RGB}{10, 77, 41}
