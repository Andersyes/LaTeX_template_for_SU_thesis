...
% ____________________________________________
    ...
    The base setup is identical to the one described in \cref{tab:wrf-chem_setup}.
    ...
    The differences between the control and the test (named \emph{INP-mp}) setup stand in the immersion and deposition modes of nucleation.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In this section, we focus on the differences between two versions of the INP-mp simulation setup.
