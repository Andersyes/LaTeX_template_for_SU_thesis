...
This appendix chapter follows the introduction section about global warming (\cref{sec:anthropo_disturbance}), and more precisely, addresses the question risen in \cref{sec:implication_sciences} about the implications of global warming near future consequences for the scientific research.
...
They take their origins in discussions with young and less young colleagues, in seminars I followed, in meetings with concerned and committed researchers (from my university and beyond), and most of all in the wavy tides of feelings that I had all along my PhD years and before.
\vspace{\baselineskip}
...
In 2024, two events threatened the researches in Earth observations from space and planetology. 
...
This suggestion issued from a thinking group made of IPSL researchers, charged to find levers that would allow the drastic reduction of the environmental footprint of our research activities.
Indeed, in a IPSL laboratory, the carbon footprint share of a researcher is between \num{10} and \SI{15}{\tonne\ce{CO2}eq\per\year}. 
It accounts only for the professional part, and yet it is at least five times the goal of \SI{2}{\tonne\ce{CO2}eq\per\year}.
...
Some cancellation appeared to be even more impactful than what would have been the moratorium on new space missions.
...
It has also demonstrated that it is preferable to do it on purpose, rather than suffer it.
...
\tempc{50} is now common in southern France, and no Spanish forest is left to burn. The agricultural production has become a major concern since the natural water supplies became chaotic.
...
This young European thinks about the past, about the people in 2020 and their actions. Did they know what would have been the future? Were they able to foresee it? What did they do to prevent the worst? 
About those very committed people, those among the most knowledgeable: were their actions commensurate with what was at stake? In their place, what would I have done?}


\vspace{\baselineskip}
Another pathway of action is to think about the evolution of research. For sure, it will greatly suffer from the future climate conditions, and will need to adapt in order to maintain itself.
In twenty years, the world would have changed so much, but will we have anticipated anything or just endured everything?
Isn't it our responsibility, as being the most climate knowledgeable citizens, to use our understanding of the present in order to fancy the future, and therefore take action to change\---if not the entire society\---our communities of researchers?
