...
Indeed, in a IPSL laboratory, the carbon footprint share of a researcher is between \num{10} and \SI{15}{\ton\ce{CO2}eq\per\year}. 
It accounts only for the professionnal part, and yet it is at least five times the goal of \SI{2}{\ton\ce{CO2}eq\per\year}.
...
% so it has been almost unanimously rejected.
