...
%%%%%%%%%%% Page normale
\pagestyle{fancy}
    \renewcommand{\chaptermark}[1]{\markboth{\color{curcolor}\thechapter.\ #1}{}}
    ...
    \fancyhead[RO]{\selectfont\uppercase{\rightmark}}
    \fancyfoot[C]{\thepage}
% Explications :
...
\ChNameVar{\fontsize{25}{25}\selectfont\textcolor{curcolor}}
\ChRuleWidth{0pt}
...
\titleformat{\chapter}[block]{
  \normalfont}{}{0pt} {
    \parbox[b]{\chapnumb}{
      \fontsize{100}{100}\selectfont\textcolor{curcolor}\thechapter}
      \parbox[b]{\dimexpr\textwidth-\chapnumb\relax}{
        \raggedleft
        \hfill{\color{curcolor} \Huge \textbf{#1}}\\
        \textcolor{curcolor}{\rule{\dimexpr\textwidth-\chapnumb\relax}{0.4pt}}
  }
}
...
\definecolor{persoblue}{HTML}{BCD4E6}
